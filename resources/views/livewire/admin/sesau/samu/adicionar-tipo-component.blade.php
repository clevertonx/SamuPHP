<div class=" p-4 m-4">
    <div class="row d-flex justify-content-center">
        ...
        <livewire:admin.sesau.samu.tipo-component  key="{{ Str::random(5) }}" title="Pessoa" model="App\Models\Admin\Sesau\Samu\Pessoa" modelId="Pessoa"
                                                   form="admin.sesau.samu.pessoa.form" />
    </div>
    <div class="row d-flex justify-content-center">
